...
#[AsCommand(
    name: 'cert:make-psqc-pdf',
    description: 'Capture the printable certificate page to PDF and save to disk(local)/psqc-certification/{code}.pdf'
)]
class CertMakePsqcPdf extends Command
{
    ...
    public function handle(): int
    {
        ...
        $certificate = PsqcCertification::where('code', $code)->first();
