...
class HomeQualityVisual extends Component
{
    ...
    public function runTest()
    {
        ...
        RunVisualTest::dispatch($this->url, $test->id)->onQueue('visual');
    ...
    {
        return $this->renderSharedView('livewire.home-quality-visual', [
