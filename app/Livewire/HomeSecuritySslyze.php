...
class HomeSecuritySslyze extends Component
{
    ...
    public function runTest()
    {
        ...
        RunSslyzeTest::dispatch($this->url, $test->id)->onQueue('sslyze');
    ...
    {
        return $this->renderSharedView('livewire.home-security-sslyze', [
