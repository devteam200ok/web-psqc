...
class HomePerformanceSpeed extends Component
{
    ...
    {
        return [
            'regions' => ['seoul', 'tokyo', 'singapore', 'virginia', 'oregon', 'frankfurt', 'london', 'sydney'],
            'test_mode' => 'global_speed'
        ];
    }
    ...
    public function runTest()
    {
        ...
        RunSpeedTest::dispatch($this->url, $test->id)->onQueue('speed');
    ...
    {
        return $this->renderSharedView('livewire.home-performance-speed', [
